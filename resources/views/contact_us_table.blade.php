            ...
            <div
                ...
                <div class="max-w-full overflow-x-auto">
                    ...
                    <table class="w-full table-auto">
                        {{-- add button --}}
                        <a href="{{route('contact.form')}}"  style="margin-top:30px;"
                            ...
                            @foreach ($contacts as $contact)
                                <tr>
                                    ...
                                    <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                        <h5 class="font-medium text-black dark:text-white">{{ \Illuminate\Support\Str::limit(strip_tags($contact->subject), 20, '...') }}</h5>
                                    </td>
                                    <td class="border-b border-[#eee]  py-5 dark:border-strokedark">
                                        <div class="flex items-center space-x-3.5">
                                            ...
                                            <button class="hover:text-primary">
                                                <a href="{{route('delete.contact',$contact->id)}}" onclick="confirmation(event)">
                                                <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
