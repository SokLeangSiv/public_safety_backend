<div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
        ...
        <button class="z-99999 block rounded-sm border border-stroke bg-white dark:bg-gray-900 p-1.5 shadow-sm lg:hidden"
        ...
        <ul class="flex items-center gap-2 2xsm:gap-4">
            ...
            <li class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                ...
                <div x-show="dropdownOpen"
                    ...
                    <ul class="flex h-auto flex-col overflow-y-auto">
                        <li>
                            <a class="flex flex-col gap-2.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2"
                                href="#">
                                <p class="text-sm">
            ...
            <li class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                ...
                <div x-show="dropdownOpen"
                    ...
                    <ul class="flex h-auto flex-col overflow-y-auto">
                        <li>
                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2"
                                href="messages.html">
