    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            ...
            <div
                ...
                <div class="flex  h-11.5 w-full items-center justify-between rounded-full bg-meta-2 dark:bg-meta-4">
            ...
            <div
                class="rounded-sm border border-stroke shadow-lg bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="flex h-11.5 w-full items-center justify-between rounded-full bg-meta-2 dark:bg-meta-4">
                    <div>
